  ...
  return (
    <>
      <motion.div
        ...
        className="border-accent-blue/30 from-accent-blue/20 via-accent-violet/20 to-accent-green/20 flex aspect-square w-full items-center justify-center rounded-2xl border bg-gradient-to-br p-2 max-md:max-h-[35rem] max-sm:max-h-96"
      >
        <motion.div
          transition={{ duration: 0.7 }}
          animate={{ rotateY: flip ? 0 : 180 }}
